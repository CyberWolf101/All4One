...
import { AccountBalanceOutlined, ArrowCircleLeft, Diversity1Outlined, Menu, NotificationsOutlined, Person2Outlined, PointOfSale, PointOfSaleOutlined, WalletOutlined } from '@mui/icons-material';
        ...
        <div className=''>
            <Fade top duration={1500}>
                <div className='mb-1 px-2 py-3 grid-nav shadow-sm bg-success fixed-top'>
                    <div className='text-white menu-div' onClick={()=> window.history.back()}>
                        <ArrowCircleLeft />
                    </div>
                    ...
                    <div className="flex " style={{ justifyContent: 'flex-end' }}>
                        <button className="btn btn-sm btn-outline-light me-1" onClick={handleAuth}>{userDetails?._id ? 'Logout' : 'Login'}</button>
