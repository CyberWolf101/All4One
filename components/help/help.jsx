...
function Help() {
    ...
    const { posts, loading: loadingPosts, setLoadMore } = useInfiniteScroll();
    ...
    return (
        <div className=''>
            ...
            <div className='updates-con'>
                {posts?.map((post) => (
                    <div key={post._id} className='mx-2 mb-5 mt-2 shadow-sm py-3'>
                        <div className="flex">
            ...
            <div className="btn btn-outline-success my-5"
